            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  // ── GST Type (replaces the old SwitchListTile) ─────
                  Obx(() => salesRadioGroup(
                        context: context,
                        label: 'GST TYPE',
                        options: const [
  ...
  Widget _extraChargesCard(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            salesSectionHeader(context, 'EXTRA CHARGES'),
            salesTwoColRow(
              context: context,
              label1: 'Discount (₹)',
  ...
  Widget _paymentCard(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            salesSectionHeader(context, 'PAYMENT'),
