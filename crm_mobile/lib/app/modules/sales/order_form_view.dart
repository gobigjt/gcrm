...
class OrderFormView extends StatefulWidget {
  const OrderFormView({super.key, this.initialCustomerId, this.orderId});
...
class _OrderFormViewState extends State<OrderFormView> {
  ...
  void initState() {
    ...
    c = Get.put(
      OrderFormController(initialCustomerId: widget.initialCustomerId, orderId: widget.orderId),
      tag: _tag,
    );
  }
  ...
  Widget build(BuildContext context) {
    final isEdit = widget.orderId != null && widget.orderId! > 0;
    final title = isEdit ? 'Edit Order' : 'New Sales Order';
    final subtitle = isEdit ? null : 'New sales order for customer';
                ...
                children: [
                  ...
                  SalesFormSectionCard(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        Text('Order note', style: salesFieldSectionLabel(context)),
                        const SizedBox(height: 6),
                        TextField(
                  ...
                  child: SizedBox(
                    ...
                    child: FilledButton(
                      ...
                      child: c.isSaving.value
                          ...
                          : Text(
                              isEdit ? 'Save Order' : 'Create Sales Order',
